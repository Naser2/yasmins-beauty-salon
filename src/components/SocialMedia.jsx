...
export const socialMediaProfiles = [
  { title: 'Instagram', href: 'https://www.instagram.com/mbeautehair', icon: InstagramIcon },
  { title: 'Facebook', href: 'https://facebook.com/mbeautehair', icon: FacebookIcon },
  { title: 'Twitter', href: 'https://www.twitter.com/mbeautehair', icon: TwitterIcon },
