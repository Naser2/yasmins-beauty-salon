    ...
    <div className={clsx('', className)}>
      <div className="e inset-x-0 z-40 bottom-[0%]  rounded-t-4xl bg-gradient-to-b from-neutral-50">
        ...
        <div className='mx-auto max-w-7xl px-6 lg:px-8 text-left'>
          ...
          <Link href="#" className="my-4 inline-flex items-center px-3 py-2 text-sm font-medium text-center text-black bg-white  hover:bg-indigo-500 focus:ring-4 focus:outline-none focus:ring-blue-300 
