...
export function Testimonial({ children, client, className }) {
  ...
  return (
    <div
      className={clsx(
        'relative isolate bg-neutral-50 py-16 sm:py-0 md:py-32 -mt-2 overflow-hidden border border-3xl    hover:rounded-3xl mb-12 ' ,
        className
      )}
    >
        ...
        <FadeIn>
          <figure className="mx-auto max-w-4xl">
            ...
            <figcaption className="mt-10">
              <Image src={client.logo} alt={client.name} unoptimized height={120} width={120}/>
            </figcaption>
          </figure>
        </FadeIn>
      </Container>
