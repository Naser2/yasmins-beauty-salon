...
const ContactCard = ({icon, title, content, href}) => {
  ...
  hover:!border-pink-400 ring-2 hover:!border-[#f4d7db] !relative">
    ...
    <div class="bg-muted flex w-full items-center hover:!border-pink-300 justify-between gap-2 !rounded-3xl p-2 ">
  
      <div class="size-4">
      <span class="text-gray-500">
    
    {icon && <div className='ml-1 w-[26px] w-[26px]  rounded-full border border-gray-400 group-hover:border-[#f4d7db] p-[8px] group-hover:!text-pink-500'>{icon}</div>}
...
{/* 
    {isPhone &&  (
          <a
            href={`tel:${content.trim().replace(/-/g, "")}`}
            target="_blank"
