 ...
 >
   <div href="https://mbeautehair.glossgenius.com/services" className="slideshow__link flex" tabindex="0">
    ...
    <FadeInStagger key={'INTRO'}>
     ...
     <p className={clsx('justify-center text-[1em] transition duration-250 transform text-sm text-white !text-[#f8e8cd] ')}> Our specialists at your service.</p>
      </div> 
